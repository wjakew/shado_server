...
public class Configuration {
    ...
    static String file_src = "config.shado";
    /**
    ...
    /**
     * Function for loading data from user to file
     */
    ...
    public void copy_configuration() throws IOException {
        ...
        try{
            ...
            fw.write("Config file created: "+ldt.toString()+"\n");
